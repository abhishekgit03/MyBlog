...
function Aboutme() {
  return (
    ...
    <div className='flex sm:flex-row flex-col justify-start items-start border-b-2'>
        <img className='rounded-full h-16 w-16 m-0 sm:mr-5 mb-4 mx-auto' src={profile}></img>
        <div>
        <div class='text-justify mb-1'>Hey, I am <strong>Abhishek Dasgupta</strong>. I am a passionate developer with a keen interest in machine learning and generative AI. I love coding and building tech communities.</div>
        ...
        <div className='mt-1'>Smart India Hackathon Finalist 2023</div>
